...
Version: 7.0.50
%define source_tag MVP-QEMU-7.0-v1.1
%define downstream_version v1.1
%define patch_number mvp3
...
Source21: %{source_url_prefix}/modules-load.conf
...
Provides: qemu-kvm-docs
Obsoletes: qemu-kvm-docs
...
Requires: %{name}-common%{?_isa} = %{epoch}:%{version}-%{release}
Provides: qemu-kvm-audio-pa
Obsoletes: qemu-kvm-audio-pa
...
Provides: qemu-kvm-ui-opengl
Obsoletes: qemu-kvm-ui-opengl
...
Provides: qemu-kvm-hw-usbredir
Obsoletes: qemu-kvm-hw-usbredir
...
run_configure() {
    ../configure \
        ...
        --extra-ldflags="%{build_ldflags} -Wl,-z,ibt -Wl,-z,shstk -Wl,-z,cet-report=error" \
        --extra-cflags="%{optflags} -Wno-error=maybe-uninitialized -fcf-protection=full -Wno-string-plus-int" \
...
mkdir -p %{buildroot}%{_datadir}/qemu-kvm/qemu-ga/fsfreeze-hook.d/
install -p -m 0644 scripts/qemu-guest-agent/fsfreeze-hook.d/*.sample %{buildroot}%{_datadir}/qemu-kvm/qemu-ga/fsfreeze-hook.d/
...
mv %{buildroot}%{_datadir}/qemu-kvm/vhost-user %{buildroot}%{_datadir}/qemu/
...
# Install simpletrace
install -m 0755 scripts/simpletrace.py %{buildroot}%{_datadir}/qemu-kvm/simpletrace.py
# Avoid ambiguous 'python' interpreter name
mkdir -p %{buildroot}%{_datadir}/qemu-kvm/tracetool
install -m 0644 -t %{buildroot}%{_datadir}/qemu-kvm/tracetool scripts/tracetool/*.py
mkdir -p %{buildroot}%{_datadir}/qemu-kvm/tracetool/backend
install -m 0644 -t %{buildroot}%{_datadir}/qemu-kvm/tracetool/backend scripts/tracetool/backend/*.py
mkdir -p %{buildroot}%{_datadir}/qemu-kvm/tracetool/format
install -m 0644 -t %{buildroot}%{_datadir}/qemu-kvm/tracetool/format scripts/tracetool/format/*.py

mkdir -p %{buildroot}%{qemudocdir}
install -p -m 0644 -t %{buildroot}%{qemudocdir} README.rst COPYING COPYING.LIB LICENSE docs/interop/qmp-spec.txt
...
install -D -p -m 0644 qemu.sasl %{buildroot}%{_sysconfdir}/sasl2/qemu-kvm.conf

# Provided by package openbios
rm -rf %{buildroot}%{_datadir}/qemu-kvm/openbios-ppc
rm -rf %{buildroot}%{_datadir}/qemu-kvm/openbios-sparc32
rm -rf %{buildroot}%{_datadir}/qemu-kvm/openbios-sparc64
# Provided by package SLOF
rm -rf %{buildroot}%{_datadir}/qemu-kvm/slof.bin

# Remove unpackaged files.
rm -rf %{buildroot}%{_datadir}/qemu-kvm/palcode-clipper
rm -rf %{buildroot}%{_datadir}/qemu-kvm/petalogix*.dtb
rm -f %{buildroot}%{_datadir}/qemu-kvm/bamboo.dtb
rm -f %{buildroot}%{_datadir}/qemu-kvm/ppc_rom.bin
rm -rf %{buildroot}%{_datadir}/qemu-kvm/s390-zipl.rom
rm -rf %{buildroot}%{_datadir}/qemu-kvm/u-boot.e500
rm -rf %{buildroot}%{_datadir}/qemu-kvm/qemu_vga.ndrv
rm -rf %{buildroot}%{_datadir}/qemu-kvm/skiboot.lid
rm -rf %{buildroot}%{_datadir}/qemu-kvm/qboot.rom

rm -rf %{buildroot}%{_datadir}/qemu-kvm/s390-ccw.img
rm -rf %{buildroot}%{_datadir}/qemu-kvm/s390-netboot.img
rm -rf %{buildroot}%{_datadir}/qemu-kvm/hppa-firmware.img
rm -rf %{buildroot}%{_datadir}/qemu-kvm/canyonlands.dtb
rm -rf %{buildroot}%{_datadir}/qemu-kvm/u-boot-sam460-20100605.bin

rm -rf %{buildroot}%{_datadir}/qemu-kvm/firmware
rm -rf %{buildroot}%{_datadir}/qemu-kvm/edk2-*.fd
rm -rf %{buildroot}%{_datadir}/qemu-kvm/edk2-licenses.txt

rm -rf %{buildroot}%{_datadir}/qemu-kvm/opensbi-riscv32-sifive_u-fw_jump.bin
rm -rf %{buildroot}%{_datadir}/qemu-kvm/opensbi-riscv32-virt-fw_jump.bin
rm -rf %{buildroot}%{_datadir}/qemu-kvm/opensbi-riscv32-generic-fw_dynamic.*
rm -rf %{buildroot}%{_datadir}/qemu-kvm/opensbi-riscv64-sifive_u-fw_jump.bin
rm -rf %{buildroot}%{_datadir}/qemu-kvm/opensbi-riscv64-virt-fw_jump.bin
rm -rf %{buildroot}%{_datadir}/qemu-kvm/opensbi-riscv64-generic-fw_dynamic.*
rm -rf %{buildroot}%{_datadir}/qemu-kvm/qemu-nsis.bmp
rm -rf %{buildroot}%{_datadir}/qemu-kvm/npcm7xx_bootrom.bin
...
rm -rf ${buildroot}%{_libdir}/qemu-kvm/ui-spice-app.so
%ifarch s390x
    # Use the s390-*.img that we've just built, not the pre-built ones
    install -m 0644 %{qemu_kvm_build}/pc-bios/s390-ccw/s390-ccw.img %{buildroot}%{_datadir}/qemu-kvm/
    install -m 0644 %{qemu_kvm_build}/pc-bios/s390-ccw/s390-netboot.img %{buildroot}%{_datadir}/qemu-kvm/
%else
    rm -rf %{buildroot}%{_libdir}/qemu-kvm/hw-s390x-virtio-gpu-ccw.so
%endif

%ifnarch x86_64
    rm -rf %{buildroot}%{_datadir}/qemu-kvm/kvmvapic.bin
    rm -rf %{buildroot}%{_datadir}/qemu-kvm/linuxboot.bin
    rm -rf %{buildroot}%{_datadir}/qemu-kvm/multiboot.bin
    rm -rf %{buildroot}%{_datadir}/qemu-kvm/multiboot_dma.bin
    rm -rf %{buildroot}%{_datadir}/qemu-kvm/pvh.bin
%endif

# Remove sparc files
rm -rf %{buildroot}%{_datadir}/qemu-kvm/QEMU,tcx.bin
rm -rf %{buildroot}%{_datadir}/qemu-kvm/QEMU,cgthree.bin
...
# Remove efi roms
rm -rf %{buildroot}%{_datadir}/qemu-kvm/efi*.rom

# Provided by package ipxe
rm -rf %{buildroot}%{_datadir}/qemu-kvm/pxe*rom
# Provided by package vgabios
rm -rf %{buildroot}%{_datadir}/qemu-kvm/vgabios*bin
# Provided by package seabios
rm -rf %{buildroot}%{_datadir}/qemu-kvm/bios*.bin
rm -rf %{buildroot}%{_datadir}/qemu-kvm/sgabios.bin
...
install -D -m 0644 %{_sourcedir}/bridge.conf %{buildroot}%{_sysconfdir}/qemu-kvm/bridge.conf
...
chmod +x %{buildroot}%{_libdir}/qemu-kvm/*.so
...
%{_libdir}/qemu-kvm/hw-display-virtio-gpu-gl.so
%ifarch x86_64 %{power64}
    %{_libdir}/qemu-kvm/hw-display-virtio-vga-gl.so
%endif
%ifarch s390x
    %{_libdir}/qemu-kvm/hw-s390x-virtio-gpu-ccw.so
%else
    %{_libdir}/qemu-kvm/hw-display-virtio-gpu-pci.so
    %{_libdir}/qemu-kvm/hw-display-virtio-gpu-pci-gl.so
%endif
    %{_libdir}/qemu-kvm/accel-qtest-%{kvm_target}.so
%ifarch x86_64
    %{_libdir}/qemu-kvm/accel-tcg-%{kvm_target}.so
%endif
%{_libdir}/qemu-kvm/hw-usb-host.so
